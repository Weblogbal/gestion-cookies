                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <select name="cg_orientation">
                                ...
                                <option value="popup" <?php selected(get_option('cg_orientation', 'middle'), 'popup'); ?>>Popup Gauche</option>
                                <option value="middle" <?php selected(get_option('cg_orientation', 'middle'), 'middle'); ?>>Popup Centré (Middle)</option>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p>
                                Ajoutez votre code JavaScript personnalisé ici extrait de <a target="_blank" href="https://tarteaucitron.io/installation-gratuite-open-source/">https://tarteaucitron.io/installation-gratuite-open-source/</a>
                            </p>
                        </td>
                    </tr>
                </table>
